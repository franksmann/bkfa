    ...
    <div class="span3">
        <div class="well sidebar-nav">
            <ul class="nav nav-list">
                ...
                <li><a href="#firm_modal" data-toggle="modal">Frima anlegen</a></li>
                <li><a href="#participant_modal" data-toggle="modal">Fahrer anlegen</a></li>
    ...
    <div class="span9">
        @if (Stock::count() > 0)
            <ul class="nav nav-tabs">
                <li class="active"><a href="#donations_table_container" data-toggle="tab">Schulungen</a></li>
                <li><a href="#firms_table_container" data-toggle="tab">Firmen</a></li>
                <li><a href="#participants_table_container" data-toggle="tab">Fahrer</a></li>
            ...
            <div class="tab-content">
                @include('plugins/firms_table')
                @include('plugins/participants_table')
            </div>
        @else
...
@section('additional_modals')
    @include('plugins/firm_modal')
    @include('plugins/participant_modal')
@endsection
