<div id="firm_modal" class="modal hide" data-backdrop="true" data-keyboard="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h3 class="modal_label">Firma anlegen</h3>
    </div>
    <div class="modal-body">
        <form action="{{ action('data@firms') }}" method="POST" class="form-inline" id="firm_modal_form">
        <div id="sku_container_modal">
            <!--<div class="form-inline-div" id="first_sku_div">-->
            <fieldset><legend>Firma</legend><input class="span3" type="text" placeholder="Firmenname" id="name1" name="name1" />
                <input class="span3" type="text" placeholder="Firmenzusatz" id="name2" name="name2" />
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-primary" data-loading-text="Posting..." onclick="$('#firm_modal_form').submit()">Submit</button>
    </div>
</div>
